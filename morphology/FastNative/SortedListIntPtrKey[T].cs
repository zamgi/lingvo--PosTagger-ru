...
namespace lingvo.morphology
{
    ...
    /// 
    /// </summary>
	internal sealed class __sorted_list_key_IntPtr__< TValue > //: IDictionary< IntPtr, TValue >, ICollection< KeyValuePair< IntPtr, TValue > >, IEnumerable< KeyValuePair< IntPtr, TValue > >
        where TValue : class
	{
		private static readonly IntPtr[] EMPTY_KEYS   = new IntPtr[ 0 ];
		...
		public int Capacity
		{
			...
			private set
			{
                if ( value != this._Keys.Length )
				{
                    ...
                    if ( value > 0 )
					{
                        IntPtr[] destinationArray  = new IntPtr[ value ];
		...
		/// <summary>Gets a collection containing the values in the <see cref="T:System.Collections.Generic.SortedListIntPtrKey`2" />.</summary>
		/// <returns>A <see cref="T:System.Collections.Generic.IList`1" /> containing the values in the <see cref="T:System.Collections.Generic.SortedListIntPtrKey`2" />.</returns>
		...
		public TValue this[ IntPtr key ]
		{
			...
			set
			{
                int n = InternalBinarySearch( _Keys, 0, _Size, key ); //Array.BinarySearch< IntPtr >( this._Keys, 0, this._Size, key ); //
                if ( n >= 0 )
                {
		...
		/// <summary>Initializes a new instance of the <see cref="T:System.Collections.Generic.SortedListIntPtrKey`2" /> class that is empty, has the default initial capacity, and uses the default <see cref="T:System.Collections.Generic.IComparer`1" />.</summary>
		public __sorted_list_key_IntPtr__()
		{
			this._Keys   = EMPTY_KEYS;
			this._Values = EMPTY_VALUES;
			this._Size  = 0;
		...
		public __sorted_list_key_IntPtr__( int capacity )
		{
            if ( capacity < 0 )
            {
                throw new ArgumentOutOfRangeException( "capacity" );
            }
            this._Keys   = new IntPtr[ capacity ];
		...
		/// <summary>Determines whether the <see cref="T:System.Collections.Generic.SortedListIntPtrKey`2" /> contains a specific value.</summary>
		/// <returns>true if the <see cref="T:System.Collections.Generic.SortedListIntPtrKey`2" /> contains an element with the specified value; otherwise, false.</returns>
		/// <param name="value">The value to locate in the <see cref="T:System.Collections.Generic.SortedListIntPtrKey`2" />. The value can be null for reference types.</param>
		...
		{
            int n = InternalBinarySearch( _Keys, 0, _Size, key );
            return (n);			
		}
		/// <summary>Searches for the specified value and returns the zero-based index of the first occurrence within the entire <see cref="T:System.Collections.Generic.SortedListIntPtrKey`2" />.</summary>
		/// <returns>The zero-based index of the first occurrence of <paramref name="value" /> within the entire <see cref="T:System.Collections.Generic.SortedListIntPtrKey`2" />, if found; otherwise, -1.</returns>
		/// <param name="value">The value to locate in the <see cref="T:System.Collections.Generic.SortedListIntPtrKey`2" />.  The value can be null for reference types.</param>
		...
		public void RemoveAt( int index )
		{
			...
			this._Keys[this._Size] = default(IntPtr);
        ...
        private static int InternalBinarySearch( IntPtr[] array, int index, int length, IntPtr value )
        {
            int i = index;
            ...
            {
                int n2 = i + (n1 - i >> 1);
                int n3 = CompareRoutine( array[ n2 ], value );
                if ( n3 == 0 )
                {
                    return n2;
                }
        ...
        unsafe private static int CompareRoutine( IntPtr x, IntPtr y )
        {
            var x_ptr = (char*) x;
            var y_ptr = (char*) y;
    ...
    */
    ...
    /// 
    /// </summary>
	internal sealed class SortedListIntPtrKey< TValue > //: IDictionary< IntPtr, TValue >, ICollection< KeyValuePair< IntPtr, TValue > >, IEnumerable< KeyValuePair< IntPtr, TValue > >
        where TValue : class
	{
        /// <summary>
        /// 
		...
		public TValue this[ IntPtr key ]
		{
			...
			set
			{
                int n = InternalBinarySearch( _Array, 0, _Size, key ); //Array.BinarySearch< IntPtr >( this._Keys, 0, this._Size, key ); //
                if ( n >= 0 )
                {
		...
		private void EnsureCapacity( int min )
		{
            int n = this._Array.Length * 3;
            //int n = (this._Array.Length == 0) ? 4 : (this._Array.Length * 2);            
			if (n > 2146435071)
			{
				n = 2146435071;
			}
        ...
        private static int InternalBinarySearch( tuple_t[] array, int index, int length, IntPtr value )
        {
            int i = index;
            int n1 = index + length - 1;
            while ( i <= n1 )
    ...
    /// 
    /// </summary>
	internal struct SortedListIntPtrKey< TValue > //: IDictionary< IntPtr, TValue >, ICollection< KeyValuePair< IntPtr, TValue > >, IEnumerable< KeyValuePair< IntPtr, TValue > >
        where TValue : class
	{
