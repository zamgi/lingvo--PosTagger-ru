...
namespace lingvo.postagger
{
    ...
    public sealed class PosTaggerResourcesModel
    {
        ...
        internal HashSet< string > Numbers               { [M(O.AggressiveInlining)] get; }
        internal HashSet< string > Abbreviations         { [M(O.AggressiveInlining)] get; }
        internal Searcher          PhrasesSearcher       { [M(O.AggressiveInlining)] get; }
        internal Searcher          AbbreviationsSearcher { [M(O.AggressiveInlining)] get; }
        internal static HashSet< string > Pretexts { [M(O.AggressiveInlining)] get; }
    }
