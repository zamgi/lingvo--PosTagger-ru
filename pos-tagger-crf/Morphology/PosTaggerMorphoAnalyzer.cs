...
namespace lingvo.postagger
{
    ...
    unsafe internal sealed class /*struct*/ MorphoAmbiguityTuple_t
    {
        ...
        public word_t               Word;
        public WordFormMorphology_t WordFormMorphology;
    ...
    unsafe internal struct WordMorphoAmbiguityFactory
    {
        ...
        public static WordMorphoAmbiguityFactory Create()
        {
            ...
            o._MorphoAmbiguityTuples_Buffer = new List< List< MorphoAmbiguityTuple_t > >( DEFAULT_WORD_COUNT );
            for ( var i = 0; i < o._MorphoAmbiguityTuples_Buffer.Capacity; i++ )
            {
                o._MorphoAmbiguityTuples_Buffer.Add( new List< MorphoAmbiguityTuple_t >( DEFAULT_WORDFORMMORPHOLOGY_COUNT ) ); 
            }
            return (o);
        }
    ...
    unsafe public sealed class PosTaggerMorphoAnalyzer : IDisposable
    {
        ...
        public PosTaggerMorphoAnalyzer( IMorphoModel morphoModel, MorphoAmbiguityResolverModel morphoAmbiguityModel )
        {
            ...
            _WordMorphoAmbiguityFactory  = WordMorphoAmbiguityFactory.Create();
        ...
        private WordFormMorphology_t[] TryGetByPosTaggerOutputType( ref WordMorphology_t wordMorphology, PartOfSpeechEnum filterPartOfSpeech )
        {
        ...
        private WordFormMorphology_t[] TryGetByPosTaggerOutputType( ref WordMorphology_t wordMorphology, PartOfSpeechEnum filterPartOfSpeech_1, PartOfSpeechEnum filterPartOfSpeech_2 )
        {
        ...
        private WordFormMorphology_t[] TryGetByPosTaggerOutputType( List< WordFormMorphology_t > wordFormMorphologies, PartOfSpeechEnum filterPartOfSpeech )
        {
